...
//DK(3/14/2022): Rd dependend on Vcmax25 and leaf temp. (see C3photosynthesis)
	//Rd25 = treesParams.Rd_mult * Vcmax25; //leaf mitochondrial respiration, umol m-2 s-1
	//E_Rd = treesParams.E_Rd;       //activation energy for leaf mitochondrial respiration, kJ mol-1
...
//Cuticular conductance
	//DK(2/14/2022): test gmin to 0.005 (Scott's value = 0.01*Gsref0)
	//DK(2/17/2022): remove Gsref0
	if (g < 0.005/1.6/42.0)
	//if (g < 0.005/1.6/42.0)
