...
std::ostream& operator << (std::ostream& out, const Data_point& dp)
{
        if (&out == &std::cout)
	{
                out << "x = "  << std::setw(14) << std::setprecision(10) << dp._x
		    << " y = " << std::setw(14) << std::setprecision(10) << dp._y << endl;
	}
	else
	{
		out << std::setw(14) << std::setprecision(10) << dp._x
                    << std::setw(14) << std::setprecision(10) << dp._y << endl;
	}
	return out;
}
...
std::ostream& operator << (std::ostream& out, const Regr_Res& res)
{
        if (&out == &std::cout)
	{
	...
	{
                out << std::setw(10) << std::setprecision(6) << res._slope << '\t'
                    << std::setw(10) << std::setprecision(6) << res._intercept << '\t'
                    << std::setw(10) << std::setprecision(6) << res._r_square;
//        out << endl;
	}
        return out;
}
...
std::ostream& operator << (std::ostream& out, const Data_Frame& df)
{
	int i;
