...
//user input
	...
	std::cin >> setname;
	std::cout << "Number of chains in set: ";
	std::cin >> n_chn;
	std::cout << "Subsampling interval: ";
	std::cin >> subgap;
...
std::cout << "Number of lines = " << n_iter << endl;
...
std::cout << "Number of variables = " << n_var << endl;
//var names
...
//samples
	...
	fout.close();
	std::cout << "finished writing " << postfile << endl;
//summary stats
...
//output
	fout.close();
	std::cout << "finished writing " << optfile << endl;
	return 1;
}
